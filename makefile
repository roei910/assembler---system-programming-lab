assembler: program.o compiler.o secondRun.o firstRun.o decodeLine.o binaryLine.o preCompiler.o
	gcc -Wall -ansi -pedantic -g program.o compiler.o secondRun.o firstRun.o decodeLine.o binaryLine.o preCompiler.o -o assembler -lm
