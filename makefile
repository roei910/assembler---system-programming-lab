assembler: assembler.o secondRun.o firstRun.o decodeLine.o binaryLine.o preAssembler.o
	gcc -Wall -ansi -pedantic -g assembler.o secondRun.o firstRun.o decodeLine.o binaryLine.o preAssembler.o -o assembler -lm
